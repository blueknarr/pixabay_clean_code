...
abstract class $PhotoCopyWith<$Res> {
  ...
  @useResult
  $Res call({num id, String imgUrl, String tags, num views});
}
...
class _$_Photo with DiagnosticableTreeMixin implements _Photo {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Photo(id: $id, imgUrl: $imgUrl, tags: $tags, views: $views)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, imgUrl, tags, views);
